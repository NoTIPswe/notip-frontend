...
OUT_DIR="src/app/generated/openapi"
...
echo "Generating Angular types → ${OUT_DIR}/${NAME}"
npx @openapitools/openapi-generator-cli generate \
  -i "${LOCAL_DIR}/${LOCAL_FILE}" \
  -g typescript-angular \
  -o "${OUT_DIR}/${NAME}"\
  --additional-properties=stringEnums=true,fileNaming=kebab-case

echo "Formatting generated file with Prettier"
npx prettier --write "${OUT_DIR}/${NAME}"
